...
class DebugOverlay{
    private:
        ...
        double m_render_load_time, m_rscene_load_time, m_rgui_load_time;
    public:
        ...
        void setRenderTimes(double render_load_time, double rscene_load_time, double rgui_load_time);
